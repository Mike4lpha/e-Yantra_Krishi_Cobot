...
class WaypointController(Node):
    ...
    def __init__(self):
        ...
        # self.waypoints = [
        #     (-0.024469, -1.6526145, 1.5893),
        #     (-0.0052318572998046875, -1.6523234558105469, -0.026180092488424), ## starting of lane 1
        #     (1.1086788177490234, -1.6666011810302734, -0.274889294301168), ## dock station (2.0158)
        #     (4.747112274169922, -1.7600841522216797, 0.023998277261853218), ## 4.90 end of lane 1
        #     (4.00, -0.78, -1.608966652547018), ## start of lane 2
        #     # (4.00, -0.78, -3.10777681),
        #     (0.50, -0.007, -3.10777681), ## end of lane 2
        #     # (0.50, -0.007, -1.57),
        #     (0.58, 1.57, -0.055623833333151), ## start of lane 3
        #     (4.35, 1.80, -0.055623833333151) ## end of lane 3
        #     # (4.97, 0.00, 1.538)
        # ]
