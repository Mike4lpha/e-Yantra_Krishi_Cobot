...
class JointServoNode(Node):
    ...
    def go_to_fertilizer(self):
        ...
        # base_target = -5.146581889658056
        # upper_link_target = -1.6444171135456493
        # forearm_target = -1.4613348024683552
        # wrist_target = -0.02976377682640554
        # ee_target = 1.9792981815989652

        ## - 0.05
        # base_target = -5.115518314188359
        # upper_link_target = -1.8361958850149696
        # forearm_target = -1.2181209538204418
        # wrist_target = -0.0426114507601968
        # ee_target = 1.980063884552344

        ## -0.02
        base_target = -5.147269962119341
        upper_link_target = -1.7641016519077004
        forearm_target = -1.3079350717942122
        wrist_target = -0.0238445646339308
        ee_target = 2.0110297192839077
    ...
    def bring_fertilizer(self):
        ...
        ## above fertlizer
        # base_target = -5.4468447048463755
        # upper_link_target = -1.461962884066194
        # forearm_target = -1.364160318235004
        # wrist_target = -0.2595006367842787
        # ee_target = 2.3102224573662524
