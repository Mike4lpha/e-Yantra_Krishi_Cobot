...
class WaypointController(Node):
    ...
    def __init__(self):
        ...
        self.waypoints = [
            (-0.020, -1.652, -1.57),
            (-0.005, -1.665, 0.00), ## start of lane 1
            (2.458, -1.6678, 0.00), ## dock station
            (2.3158, -1.6678, 0.00),
            (4.604, -1.78, 0.00), ## 4.90 end of lane 1
            (4.70, 0.1, 1.57),
            (4.70, 0.1, 3.14), ## start of lane 2
            (0.50, -0.04, 3.14), ## end of lane 2
            (0.58, 1.60, 0.00), ## start of lane 3  ## y = 1.50
            (4.66, 1.65, 0.00), ## end of lane 3  ## shift more right
            # (4.70, 0.0, -1.57),
            # (0.0, 0.0, 3.14)
            (4.70, -1.760, -1.57),
            (2.3158, -1.75, 3.14), ## dock station
            (-0.005, -1.652, 3.14),
            (-0.024, -1.652, 1.57),
            (0.0, 0.0, 0.0)
        ]
        ...
        self.obstacle_distance_threshold_front = 0.0    ### 0.2
        self.obstacle_distance_threshold_side = 0.0     ### 0.2
    ...
    def detection_callback(self, msg: String):
        ...
        self.detection_hold_end_time = now + 3.0 
        self.publish_stop()
